...
def main():
    ...
    try:
        ...
        # Total number of moves (independent, both White and Black)
        ...
        for n in range(1, total_moves + 1):
            ...
            # Get the FEN of the position after each individual move
            ...
            score = factor*float(analysis.split("score cp ")[-1].split(" ")[0])/100
            print(f"Score: {score}\n")
