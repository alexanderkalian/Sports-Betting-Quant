...
def generate_embeddings(fens, config_name="CT-EFT-85"):
    """
    Generate the final contextual embedding for the last move in a sequence of FENs using the chess-transformers model.
    ...
    :return: Final contextual embedding for the last move.
    """
    ...
    with torch.no_grad():
        contextual_embeddings = model._orig_mod.board_encoder(
            turns,
            white_kingside,
            white_queenside,
            black_kingside,
    ...
    # Directly return the final embedding for the last move
    return contextual_embeddings.clone()
...
if __name__ == "__main__":
    ...
    fens = parse_pgn_to_fens(PGN_TEXT3)
