...
1. g4 d5 2. Bg2 Bxg4 3. c4 c6 4. cxd5 cxd5 5. Qb3 Nf6 6. Nc3 Nc6 7. Nxd5 Nd4
8. Nxf6+ exf6 9. Qxb7 Rb8 10. Qe4+ Be6 11. Nf3 Bc5 12. Nxd4 Qxd4 13. Qxd4 Bxd4
14. O-O Bxb2 15. Rb1 O-O 16. Rxb2 Rxb2 17. Bxb2 Rc8 18. Bc3 Rc5 19. Rb1 h5
20. Rb8+ Kh7 21. Ra8 Rb5 22. h3 h4 23. Kh2 Bd5 24. Bxd5 Rxd5 25. Rxa7 Rf5
26. Kg2 Kg6 27. a4 Rg5+ 28. Kh2 Rf5 29. Kg1 Rc5 30. a5 Rb5 31. Rd7 Rc5 32. a6 Rc6
33. a7 Ra6 34. Bd4 Ra2 35. e4 Ra5 36. f4 Ra4 37. f5+ Kg5 38. Be3+ Kh5 39. Rd8 Rxe4
40. a8=Q Rxe3 41. Qg2 Rg3 42. Rh8+ Kg5 43. Qxg3+ hxg3 44. Kg2 Kxf5 45. Kxg3 Kg6
46. Ra8 Kf5 47. Ra5+ Ke4 48. Kg4 g6 49. Kg5 f5 50. Ra4+ Kf3 51. h4 f4 52. Rxf4+
Kg3 53. Kxg6 Kxf4 54. h5 Ke5 55. h6 Ke6 56. h7 Ke7 57. h8=Q Ke6 1-0
"""
...
def generate_embeddings(fens, config_name="CT-EFT-85"):
    """
    Extract outputs directly from the multi-headed attention layers during a full encoder forward pass.
    Return the outputs as a single tensor.
    ...
    :return: A tensor of shape (num_layers, num_moves, seq_len, embedding_dim).
    """
    ...
    # Prepare inputs
    turns, white_kingside, white_queenside, black_kingside, black_queenside, board_positions = [], [], [], [], [], []
    ...
    # Define a hook function to capture MHA outputs
    def hook(module, input, output):
        attention_outputs.append(output)

    # Register hooks on all MHA layers
    hooks = []
    for encoder_layer in model._orig_mod.board_encoder.encoder_layers:
        mha_layer = encoder_layer[0]  # MultiHeadAttention
        hooks.append(mha_layer.register_forward_hook(hook))

    # Run the full encoder to trigger hooks
    with torch.no_grad():
        model._orig_mod.board_encoder(
            turns,
            white_kingside,
            white_queenside,
            black_kingside,
    ...
    # Combine attention outputs into a single tensor
    attention_tensor = torch.stack(attention_outputs)  # Shape: (num_layers, num_moves, seq_len, embedding_dim)
...
if __name__ == "__main__":
    ...
    first_state = embeddings[-1][-1].clone()
    ...
    print("Embeddings (last move):", embeddings[-1][-1])
    
    embedding1 = first_state
    embedding2 = embeddings[-1][-1]
    
    import torch.nn.functional as F
    # Ensure the shapes match (both are [69, 768])
    if embedding1.shape == embedding2.shape:
        similarities = F.cosine_similarity(embedding1, embedding2, dim=1)  # Output: [69]
        print("Token-wise cosine similarities:", similarities)
    else:
        raise ValueError(f"Shape mismatch: {embedding1.shape} vs {embedding2.shape}")
